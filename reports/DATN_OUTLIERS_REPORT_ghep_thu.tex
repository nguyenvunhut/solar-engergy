...
% catcode nen an toan.
%
% Luu y: vong lap doc doi so khong bao gom dau cach, nen \texttt{...} KHONG duoc chua dau cach.
% Ba cho tung co dau cach da duoc tach thanh \texttt{a}${}={}$\texttt{b}.
\makeatletter
