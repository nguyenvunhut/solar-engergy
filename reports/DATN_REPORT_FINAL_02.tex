...
liệu và chỉ từ phần huấn luyện: \texttt{site\_scale} là phân vị $99$ của sản lượng ban
...
Giá trị dùng để huấn luyện và để chấm điểm ở Mục~\ref{sec:danh_gia_tren_tap_test} là $1{,}3764$.
...
phạm vi đợt này và được ghi vào hướng phát triển ở Mục~\ref{subsec:huong_phat_trien}. Mọi con số H$4$ trong báo cáo đều
...
chính chuỗi sản lượng. Bảng xếp hạng này khớp với kết quả tự tương quan ở Mục~\ref{subsec:kham_pha_du_lieu}: chuỗi mang
...
\midrule
\textbf{Tổng số đặc trưng} & $\mathbf{40}$ & \\
\bottomrule
\end{tabularx}
\end{table}
...
sinh. Hai cấu hình đó nằm ở Mục~\ref{subsec:huong_phat_trien} như hướng phát triển tiếp theo.
...
\texttt{ghi\_cs\_mt}, tức bức xạ trời quang tại thời điểm mục tiêu.
...
Trang này đưa kết quả SHAP ở Mục~\ref{sec:giai_thich_mo_hinh} lên giao diện: tỷ trọng đóng góp theo nhóm đặc trưng, xếp
...
định trước khi tập test được mở, và mọi chỉ số báo cáo ở Mục~\ref{sec:danh_gia_tren_tap_test} đều là kết quả của lần mở
duy nhất đó.
