...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Khi xuất hiện mã \texttt{PHYSICAL\_HIGH\_ENERGY\_NO\_SUN} hoặc 
        \texttt{PHYSICAL\_DISTRIBUTION\_JUMP}: Khoanh vùng xử lý lỗi cảm biến dòng điện (CT sensor drift), hiện tượng dòng rò ngược ban đêm hoặc xung nhiễu đường truyền viễn thông (telemetry spike) mà không cần rà soát toàn bộ dàn pin.
    \end{itemize}
