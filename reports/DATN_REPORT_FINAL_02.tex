...
Cận cắt suy từ dữ liệu, không đặt tay. Tham số $k_{\max}$ không được gán một hằng số
...
Sàn mẫu số $\varepsilon$ \textbf{không quyết định độ chính xác.} Toàn dải từ $0{,}00$ tới
...
Cận cắt là tham số có tác động rõ, và không còn là hằng số đặt tay. Nó được suy từ
...
\begin{itemize}
    ...
    \item \textbf{Sai số phân bố không đều giữa các trạm}, từ $12{,}69\%$ tới $26{,}06\%$ ở
    tầm H1, và $15{,}65\%$ tới $33{,}02\%$ ở tầm H4. Mô hình dùng chung chưa mô tả hết phần khác
    biệt riêng của từng trạm.
    \item \textbf{Độ trễ pha còn tồn tại ở mức thấp}: cổng đo trước bước tinh chỉnh cho
    $+2{,}38$ phút trên toàn tập kiểm định, dưới ngưỡng $\pm 5$ phút và không trạm nào vượt,
    nhưng vẫn nghiêng về phía trễ.
