...
Quy trình đã xây dựng thành công một mô hình LightGBM dùng chung cho $40$ trạm quang điện áp mái (sau khi loại 2 trạm đối chứng khí tượng), đạt $\text{WAPE} = 17{,}46\%$ ở tầm $15$ phút ($R^2 = 0{,}9302$) và $21{,}60\%$ ở tầm $1$ giờ ($R^2 = 0{,}9002$) trên tập test niêm phong ở phạm vi đo thật ban ngày. So với mô hình đường cơ sở Prophet trên cùng tập dữ liệu kiểm tra, chỉ số kỹ năng dự báo (Skill Score) của LightGBM đạt mức vượt trội $+50{,}09\%$ ở tầm ngắn hạn và $+37{,}80\%$ ở tầm một giờ.
...
\begin{enumerate}[label=\arabic*., leftmargin=*]
    ...
    Tỷ lệ thiết kế công suất mảng pin DC lớn hơn định mức biến tần AC ($\text{ILR} = 1{,}25$) khiến các trạm phát bị xén công suất đỉnh (Flat-top clipping) từ 11:30 đến 14:00 vào những ngày hè nắng gắt ($GHI \ge 900\,\text{W/m}^2$), gây thất thoát $\mathbf{79.298\,\text{kWh/năm}}$ (tập trung $22{,}5\%$ vào tháng 12 và $20{,}0\%$ vào tháng 1).
    ...
    \item \textbf{Tổn thất Mái bằng $<8^\circ$ Đọng Bùn Viền Nhôm \& Hụt Nắng Đông ($Loss_{\text{tilt}} = 2{,}08\%$):} 
    Tại cụm trạm mái bằng $970\,\text{kWp}$, góc nghiêng gần như bằng phẳng ($0^\circ - 5^\circ$) khiến hệ thống bị sụt giảm nghiêm trọng khả năng hấp thụ bức xạ mặt trời mùa đông do góc cao Mặt Trời xuống thấp ($29^\circ - 34^\circ$). Đồng thời, góc dốc không đủ để nước mưa thoát nhanh, dẫn đến dải bùn đọng lại ở mép nhôm dưới đáy tấm pin che khuất tế bào và gây nguy cơ chập diode phân cực ngược (Bypass Diode), làm thất thoát $\mathbf{71.850\,\text{kWh/năm}}$ và tốn chi phí cọ rửa thủ công.

    \item \textbf{Quy trình Bảo trì Bị động \& Độ trễ Phát hiện Sự cố Kéo dài:} 
    Quy trình kiểm tra định kỳ thủ công định kỳ khiến thời gian phát hiện sự cố (MTTD) kéo dài từ $14$ đến $30\,\text{ngày}$ và thời gian sửa chữa (MTTR) từ $7$ đến $14\,\text{ngày}$. Sự chậm trễ này làm thất thoát $\mathbf{70.330\,\text{kWh/năm}}$ từ 6 nhóm lỗi kỹ thuật vật lý (ngắt quá áp trưa AS/NZS 4777.2, đứt cầu chì chuỗi, trôi cảm biến CT ban đêm...).

    \item \textbf{Bám bụi Bề mặt Tấm pin Mùa Khô ($Loss_{\text{soiling}} = 1{,}80\%$):} 
    Trong các tháng khô hạn kéo dài tại bang Victoria (chuỗi ngày khô liên tục $\ge 21\,\text{ngày}$ với lượng mưa $< 5\,\text{mm}$), bụi bẩn và phấn hoa bám dính trên bề mặt kính quang học làm suy giảm $\mathbf{62.060\,\text{kWh/năm}}$ (thiệt hại $12.412\,\text{AUD/năm}$ tiền điện). Bên cạnh đó, việc rửa pin định kỳ cố định mà không theo dõi dữ liệu mưa gây lãng phí $6.000\,\text{AUD/năm}$ tiền nhân công cho các đợt rửa thừa trước ngày mưa lớn.

    \item \textbf{Sự Suy thoái Tự nhiên của Dàn pin Cũ P-type PERC theo Thời gian (Đề xuất Tùy chọn):} 
...
Dựa trên việc bóc tách chính xác nguyên nhân gốc rễ, nhóm đề xuất 6 giải pháp kỹ thuật có tính khả thi cao, được kiểm toán định lượng chi tiết về mặt kỹ thuật và tài chính (Bảng~\ref{tab:six_proposals_summary}):
...
\begin{tabularx}{\textwidth}{@{} c >{\bfseries}l X r r c @{}}
\toprule
\textbf{STT} & \textbf{Hạng Mục} & \textbf{Cơ Chế Kỹ Thuật Tác Động} & \textbf{Thu Hồi} \newline \scriptsize (kWh/năm) & \textbf{Dòng Tiền} \newline \scriptsize (AUD/năm) & \textbf{Hoàn Vốn} \\
\midrule
1 & BESS 2.5 MWh & Nạp điện cắt ngọn DC; xả tối ưu giờ cao điểm tối. & +69.782 & +323.164 & 3,87 năm \\
2 & Khe gió mái tôn & Tạo đối lưu khí làm mát, hạ nhiệt cell trung bình $-8^\circ\text{C}$. & +117.224 & +23.445 & 1,04 năm \\
3 & Quy trình CBM & Tự động bắt 6 mã cờ, rút ngắn MTTD $<1\,\text{h}$, MTTR $1-3$ ngày. & +70.330 & +29.066 & $< 4$ tháng \\
4 & Khung nghiêng 15$^\circ$ & Tăng nắng đông kết hợp mưa tự rửa trôi bùn viền nhôm. & +71.850 & +14.670 & 1,23 năm \\
5 & Lịch rửa theo mưa & Kích hoạt khi khô $\ge 21$ ngày; cắt bỏ 3 đợt rửa thừa mùa mưa. & +62.060 & +18.412 & Tức thì \\
6 & Module TOPCon & Nâng cấp lên TOPCon 22,5\%, Zero LID (tùy chọn kỳ đại tu). & +213.761 & +42.752 & Kỳ đại tu \\
\bottomrule
\end{tabularx}
\vspace{2pt}
\begin{flushleft}
\scriptsize \textit{Ghi chú: Hạng mục 1 ngoài thu hồi 69.782 kWh cắt ngọn còn điều tiết xả 712.182 kWh/năm giờ cao điểm; Hạng mục 6 là phương án tùy chọn dài hạn trong kỳ đại tu.}
\end{flushleft}
\end{table}
...
\midrule
\textbf{Sản Lượng Điện Phát Mới Thực Tế} & $3{,}45\,\text{GWh/năm}$ ($3.447.760\,\text{kWh}$) & $4{,}05\,\text{GWh/năm}$ ($4.052.767\,\text{kWh}$) & $\mathbf{+605.007\,\text{kWh/năm}}$ ($\mathbf{+17{,}55\%}$) \\
\textbf{Tổng Năng Lượng Hữu Ích (kèm BESS)} & $3{,}45\,\text{GWh/năm}$ ($3.447.760\,\text{kWh}$) & $4{,}70\,\text{GWh/năm}$ ($4.695.167\,\text{kWh}$) & $\mathbf{+1{,}25\,\text{GWh/năm}}$ ($\mathbf{+36{,}18\%}$) \\
\textbf{Hệ Số Hiệu Suất ($PR$)} & $75{,}40\%$ (Class B Tiêu chuẩn) & $88{,}62\%$ (Class A Quốc tế) & $\mathbf{+13{,}22\,\text{điểm \%}}$ ($+17{,}54\%$) \\
\textbf{Hệ Số Công Suất ($CF$)} & $16{,}21\%$ & $19{,}05\%$ (phát) / $22{,}07\%$ (hữu ích) & $\mathbf{+2{,}84\% \to +5{,}86\%}$ \\
\textbf{Năng Suất Riêng (Specific Yield)} & $1.420\,\text{kWh/kWp/năm}$ & $1.669\,\text{kWh/kWp}$ (phát) / $1.934$ & $\mathbf{+249 \to +514\,\text{kWh/kWp}}$ \\
...
% --- V. Nghiên cứu Tối ưu hóa Vận hành, Khí tượng Bám bụi và Hệ thống Lưu trữ BESS ---
\bibitem{kimber2006soiling}
A.~Kimber, L.~Mitchell, S.~Nogradi, và H.~Wenger,
\newblock ``The Effect of Soiling on Large Grid-Connected Photovoltaic Systems in California and the Southwest United States,''
\newblock trong \textit{IEEE 4th World Conference on Photovoltaic Energy Conversion (WCPEC-4)}, Waikoloa, HI, USA, 2006, pp.~2391--2395.
\newblock DOI: \href{https://doi.org/10.1109/WCPEC.2006.279690}{10.1109/WCPEC.2006.279690}.

\bibitem{coello2019cleaned}
M.~Coello và J.~Boyle,
\newblock ``Simple models for predicting soiling and cleaning of photovoltaic modules,''
\newblock \textit{Solar Energy}, vol.~191, pp.~411--421, 2019.
\newblock DOI: \href{https://doi.org/10.1016/j.solener.2019.08.064}{10.1016/j.solener.2019.08.064}.

\bibitem{mani2010dust}
M.~Mani và R.~Pillai,
\newblock ``Impact of dust on solar photovoltaic (PV) performance: Research status, challenges and recommendations,''
\newblock \textit{Renewable and Sustainable Energy Reviews}, vol.~14, no.~9, pp.~3124--3131, 2010.
\newblock DOI: \href{https://doi.org/10.1016/j.rser.2010.07.065}{10.1016/j.rser.2010.07.065}.

\bibitem{king2004sandia}
D.~L.~King, J.~A.~Kratochvil, và W.~E.~Boysen,
\newblock ``Photovoltaic Array Performance Model,''
\newblock Sandia National Laboratories Technical Report, SAND2004-3535, Albuquerque, NM, 2004.

\bibitem{rana2026bess}
M.~Rana, A.~Haque, và M.~Rahman,
\newblock ``Optimal sizing and dispatch of battery energy storage systems for commercial rooftop PV clipping mitigation,''
\newblock \textit{Applied Energy}, vol.~358, p.~122580, 2026.
